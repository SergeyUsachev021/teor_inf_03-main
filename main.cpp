...
int main(){
    ...
    const std::string input_filename = "C:/Users/SerGO/Desktop/teor_inf_03-main/input_for_1.txt";// файл для закодирования алгоритмом Шенноном
    const std::string binary_sequence_filename = "C:/Users/SerGO/Desktop/teor_inf_03-main/bin_input_for_1.txt";//файл для декодирования алгоритмом Шеннона 
    const std::string binary_sequence_filename_2 = "C:/Users/SerGO/Desktop/teor_inf_03-main/input2_forHaf.txt";//файл для декодирования алгоритмом Хаффмена  
    const std::string output_filename = "C:/Users/SerGO/Desktop/teor_inf_03-main/encoded_output2.txt";
    const std::string output_filenameHUF = "C:/Users/SerGO/Desktop/teor_inf_03-main/HUF.txt";
    const std::string encoded_filename = "C:/Users/SerGO/Desktop/teor_inf_03-main/build/encoded_output_shannon.txt";// файл для записи кодов алгоритмом Шеннона
    const std::string encoded_filename_2 = "C:/Users/SerGO/Desktop/teor_inf_03-main/build/encoded_output22.txt";//файл для записи кодов полученных при закодировании Хаффменом 
